...
class TestTradingConfig:
    ...
    def test_position_size_validation(self):
        ...
        # Valid
        config = TradingConfig(position_sizing={"min": 0.3, "max": 0.7})
        assert config.min_position_size == 0.3
        assert config.max_position_size == 0.7

        # Invalid - max < min
        with pytest.raises(ValidationError):
            TradingConfig(position_sizing={"min": 0.7, "max": 0.3})
...
class TestAPIConfig:
    ...
    def test_api_key_validation(self):
        ...
        # Valid
        config = APIConfig(
            binance_api_key="valid_api_key_12345", binance_api_secret="valid_secret_12345"
        )
    ...
    def test_discord_webhook_validation(self):
        ...
        # Valid
        config = APIConfig(discord_webhook="https://discord.com/api/webhooks/123/abc")
...
class TestConfig:
    ...
    def test_load_from_file(self, tmp_path):
        ...
        config_data = {
            "trading": {"stop_loss": 5.0, "sell_threshold": 0.5},
            "market_analysis": {"rsi_period": 20},
        }
...
class TestConfigSingleton:
    ...
    def test_config_with_file_and_env(self, tmp_path):
        ...
        # Create config file
        config_data = {"trading": {"stop_loss": 5.0, "sell_threshold": 0.5}}
